      ...
      <div className="navHolder">
        ...
        <div className="navbar">
          ...
          <div className="authBar">
            <Link className="text-white text-lg px-4 py-2 rounded hover:bg-[#1e293b] transition duration-200">Register</Link>
            <Link className='text-white text-lg px-4 py-2 rounded hover:bg-[#1e293b] transition duration-200'>Login</Link>
          </div>
