        ...
        <tbody className="divide-y divide-gray-700">
          {data.map((item) => (
            <tr key={item.id} className="hover:bg-[#1e293b] transition">
              ...
              <td className="px-4 py-3 text-purple-400 hover:underline cursor-pointer">{item.longUrl}</td>
              <td className="px-4 py-3">{item.icon}</td>
              <td className="px-4 py-3 text-purple-400 hover:underline cursor-pointer">{item.shortUrl}</td>
